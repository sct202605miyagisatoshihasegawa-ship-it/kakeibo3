...
public class PaymentMethodTableCell
		extends TableCell<TransactionProperty, PaymentMethodType> {

	private final ComboBox<PaymentMethodType> comboBox =
			new ComboBox<>(
					FXCollections.observableArrayList(
							PaymentMethodType.values()));

	public PaymentMethodTableCell() {
